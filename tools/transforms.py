...
# def transform_vel(vel, T):
#     vel_linear = vel[:3]
#     vel_angular = vel[3:]
#     rotation_matrix = T[:3, :3]
#     trans_vec = T[:3, 3]
#     vel_linear = np.dot(rotation_matrix, vel_linear)
#     vel_angular = np.dot(rotation_matrix, vel_angular)
#     vel = np.concatenate([vel_linear, vel_angular])
#     return vel
